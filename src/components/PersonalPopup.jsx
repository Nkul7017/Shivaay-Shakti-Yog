        ...
        <div className="w-[90vw] h-[90vh]    " data-aos="zoom-in">
          <div className=" w-[80vw] mx-auto h-[80vh] mt-10 overflow-y-auto scrollbar-hide ">
            <div className=" flex flex-col lg:flex-row justify-between items-start gap-y-6 lg:items-center ">
              <p className=" heading text-xl sm:text-3xl md:text-6xl">
              ...
              <div className=" flex  flex-wrap gap-2  sm:gap-4">
                ...
                >
                  <span className=" flex gap-2 items-center">
                    Scheduled classes <FaCalendarDays />{" "}
                  </span>
                </button>
              </div>
              <div
            ...
            <p className=" para text-sm sm:text-2xl mt-5 pl-3 ">
              Personal Course{" "}
      ...
      >
        <div className="w-[90vw] h-[90vh]    " data-aos="zoom-in">
          <div className=" w-[80vw] mx-auto h-[80vh] mt-10 overflow-y-auto scrollbar-hide ">
            ...
            <p className=" para text-xl sm:text-2xl mt-5 pl-3 ">
              Personal Course{" "}
              <span className=" heading text-sm sm:text-xl  ml-6 sm:ml-16 ">
                {data?.preferred_timing}
              </span>
            </p>
            <style>{css}</style>
            <DayPicker
              ...
              fixedWeeks
              numberOfMonths={
                data?.duration === "9 Month"
                  ? 15
                  : data?.duration === "3 Month"
                  ? 6
