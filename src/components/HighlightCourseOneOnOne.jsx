...
const HighlightCourseOneOnOne = (data) => {
  return (
    <>
      ...
      <div id="Highlights" className=" shadow-2xl lg:w-[80%] lg:ml-28  mt-4 ">
...
export default HighlightCourseOneOnOne;
