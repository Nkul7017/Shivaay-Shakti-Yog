  ...
  const handleUploadedImage = async (imageUrl, thnl) => {
    try {
      const response = await axios.put(
        `https://shivaay-shakti-backend-vm3k.onrender.com/api/auth/update/${user?._id}`,
        {
  ...
  return (
    <div className=" flex     px-2 lg:px-16 border flex-wrap g justify-between h-[160px]        ">
      <div className=" flex gap-5 sm:gap-3   lg:gap-10 justify-center items-center   ">
        <div
          onMouseOver={() => setToggle2(true)}
          onMouseOut={() => setToggle2(false)}
          className=" relative w-[80px] h-[80px] md:w-[150px] md:h-[150px] lg:w-[236px] lg:h-[236px]
       mt-0     lg:-mt-14 "
        >
          <img
            src={imageprofile}
            className="  w-[100%] h-[100%]
         rounded-full image object-cover object-top  "
            alt=""
          />
        ...
        <div className=" flex flex-col gap-1  ">
          <p className=" heading text-[18px]   lg:text-4xl capitalize ">
            {user?.name}
          </p>
      ...
      <div className=" flex  gap-14  sm:gap-10 ">
        <div className=" flex  md:-mt-0  gap-2 sm:gap-6  lg:gap-10 items-center justify-center  ">
          <div className="  items-center flex gap-1  md:flex-col  ">
            <p className="w-[36px] lg:w-[45px]  aspect-square  grid place-content-center  rounded-xl bg-[#2C3E50] text-white text-[18px] md:text-2xl ">
        ...
        <div className="flex gap-5 sm:gap-4 md:gap-8 lg:gap-12 items-center justify-center    ">
          <div className=" flex flex-col items-center justify-center  gap-2 ">
            <button onClick={() => setToggle3(true)}>
              <img
                src={heart}
                className=" hover:scale-110  w-[20px] h-[20px] lg:w-[30px] lg:h-[30px] "
                alt=""
              />
            </button>
          ...
          <div className=" flex flex-col items-center justify-center  gap-2 ">
            ...
            >
              <div
                data-aos="fade-up"
                className="relative   hi w-[90vw] sm:w-[60vw] md:w-[50vw] bg-[#FFF1C1] p-20 "
              >
                    ...
                    <div className="flex flex-col mt-4 gap-3">
                      <div className=" flex flex-col gap-1 ">
                        ...
                        <input
                          ...
                          value={data.name}
                          onChange={handle}
                          className=" w-[220px] lg:w-[400px] h-6 lg:h-8 p-1 rounded "
                        />
                      </div>
                      <div className=" flex flex-col  lg:flex-row gap-2 lg:gap-5 ">
                        <div className=" flex flex-col gap-1  ">
                          ...
                          <input
                            ...
                            name="born"
                            onChange={handle}
                            className="p-1 rounded  h-6 sm:h-8  "
                          />
                        </div>
                        <div className=" flex flex-col gap-1 ">
                          <label
                          ...
                          <input
                            ...
                            value={data.country}
                            onChange={handle}
                            className="  h-6 lg:h-8 p-1 rounded"
                          />
                        </div>
                      </div>
                      <div className=" flex flex-col gap-1">
                        ...
                        <input
                          ...
                          name="city"
                          onChange={handle}
                          className="p-1 rounded w-[180px]  lg:w-[228px] h-6 sm:h-8 "
                        />
                      </div>
                      ...
                      <div>
                        <div className=" flex flex-col gap-1 ">
                          ...
                          <input
                            ...
                            value={data.gender}
                            onChange={handle}
                            className=" w-full sm:w-2/3 h-6 lg:h-8 p-1 rounded "
                          />
                        </div>
                      </div>
                        ...
                        <div className=" flex flex-col gap-1">
                          ...
                          <div className=" flex gap-2 ">
                            <input
                              ...
                              value={data.height}
                              onChange={handle}
                              className=" w-[50px] lg:w-[140px] h-8 p-1 rounded"
                            />
                            <select
                              onChange={handle}
                              name="hunit"
                              className=" border border-[#2C3E50] rounded-md px-2 h-8  "
                            >
                ...
                <div className=" absolute top-5 right-5  ">
                  <button onClick={() => setToggle1(false)}>
        ...
        >
          <div className=" flex flex-wrap gap-x-10 gap-y-3 ">
            ...
            <div className="flex  items-center gap-3 ">
              ...
              <p>
                {new Date().getFullYear() - new Date(user?.born).getFullYear()}
              </p>
            </div>
          </div>
          ...
          <div className=" absolute top-5 right-5  ">
            <button onClick={() => setToggle3(false)}>
              <HiXMark className="  text-3xl lg:text-4xl " />
            </button>
          </div>
        </div>
