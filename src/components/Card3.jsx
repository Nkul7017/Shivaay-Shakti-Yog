...
background: `linear-gradient(180deg, rgba(121, 217, 249, 0.00) 0.07%, #E6F5FA 99.93%),url(${img}) center/cover no-repeat `
        ...
        {types==="Personal"&&<PersonalForm type={"personal"} data={data} toggle1={toggle1} setToggle1={setToggle1} />}
        {types==="Group"&&<GroupForm type={"group"} data={data} toggle1={toggle1} setToggle1={setToggle1} />}
