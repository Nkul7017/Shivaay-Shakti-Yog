...
function Slug() {
  ...
  useEffect(() => {
    if (userId !== null && userId !== undefined) {
      axios
        .get(
          `https://shivayshaktibackend.onrender.com/trainee/user/${userId.slice(
            1,
            25
          )}`
        )
  ...
  /// User data Dispatch To Redux store
  ...
  // let result = FilterData.filter(function (item) {
  //   let TitleData = item?.title.toLowerCase();

  //   let inputLower = input.toLowerCase();

  //   return TitleData.indexOf(inputLower) != -1;
  // });
  ...
  useEffect(() => {
    console.log("useEffect Runnnnnnnn");

    if (category == "General Fitness") {
      setCategoryMsg(
        " Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium rerum enim excepturi mollitia aliquid ipsa, iste ipsum illum delectus, minus impedit ad, recusandae iure rem ducimus accusantium dicta nesciunt! Velit, quia cumque.    "
      );
    } else if (category == "Weight Management") {
      setCategoryMsg(
        " Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium rerum enim excepturi mollitia aliquid ipsa, iste ipsum illum delectus, minus impedit ad, recusandae iure rem ducimus accusantium dicta nesciunt! Velit, quia cumque.      "
      );
    } else if (category == "Mental Wellness") {
      setCategoryMsg(
        " Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium rerum enim excepturi mollitia aliquid ipsa, iste ipsum illum delectus, minus impedit ad, recusandae iure rem ducimus accusantium dicta nesciunt! Velit, quia cumque.      "
      );
    } else if (category == "Medical Conditions") {
      setCategoryMsg(
        " Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium rerum enim excepturi mollitia aliquid ipsa, iste ipsum illum delectus, minus impedit ad, recusandae iure rem ducimus accusantium dicta nesciunt! Velit, quia cumque.      "
      );
