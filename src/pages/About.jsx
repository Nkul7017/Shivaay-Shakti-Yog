        ...
        <div className=" hidden  sm:flex   flex-col lg:flex-row md:px-2  lg:px-28 gap-10 mt-14 justify-between  ">
          <div className=" flex flex-col lg:flex-row items-center justify-center lg:w-1/2  text-justify  ">
            ...
            <div className=" space-y-5 mt-0 sm:mt-10 lg:mt-0    text-black text-[18px] para ">
              <p>
                Our mission is to provide a convenient and accessible platform
                for individuals of all levels to practice yoga from the comfort
                of their own homes. Whether you're a beginner looking to explore
                the benefits of yoga or an experienced yogi seeking to deepen
              ...
              <p>
                ...
                accountability, and personalized guidance. Through our
                interactive platform, you'll have the opportunity to connect
                with expert teachers and fellow practitioners from around the
                globe, creating a supportive and uplifting environment.
              </p>
            </div>
          </div>
          <div className="  lg:w-1/2">
