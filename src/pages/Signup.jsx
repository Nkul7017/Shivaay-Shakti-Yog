          ...
          <form onSubmit={handlesubmit}>
              ...
              <div className="flex flex-col mt-4 gap-3">
                <div className=" flex flex-col gap-1 ">
                  ...
                  <input
                    ...
                    value={data.name}
                    onChange={handle}
                    className=" w-[220px] lg:w-[400px] p-3 h-6 lg:h-8 rounded "
                  />
                </div>
                <div className=" flex flex-col  lg:flex-row gap-2 lg:gap-5 ">
                  <div className=" flex flex-col gap-1">
                    ...
                    <input
                      ...
                      name="born"
                      onChange={handle}
                      className="w-[220px]  p-3  h-6 sm:h-8  rounded "
                    />
                  </div>
                  <div className=" flex flex-col gap-1">
                    <label
                ...
                <div className=" flex flex-col gap-1">
                  ...
                  <input
                    ...
                    name="city"
                    onChange={handle}
                    className="w-[220px] lg:w-[400px] p-3   h-6 sm:h-8  rounded"
                  />
                </div>
                  ...
                  <div className=" flex flex-col gap-1">
                    ...
                    <div className=" flex gap-2 ">
                      <input
                        ...
                        value={data.height}
                        onChange={handle}
                        className=" w-[50px] p-1 md:p-3 lg:w-[140px] h-8 rounded"
                      />
                      <select
                        onChange={handle}
                        name="hunit"
                  ...
                  <div className=" flex flex-col gap-1">
                    ...
                    <div className=" flex gap-2 ">
                      <input
                        ...
                        value={data.weight}
                        onChange={handle}
                        className="p-1 md:p-3 w-[50px] lg:w-[140px] h-8  rounded  "
                      />
                      <select
                        id="weight"
                        onChange={handle}
            ...
            {data.next === 2 && (
              <div className="flex flex-col mt-4 gap-3">
                ...
                <div className=" flex    gap-3 lg:gap-5  flex-col xl:flex-row ">
                  <div className=" flex flex-col gap-2 w-full sm:w-1/3 ">
                    ...
                    <input
                      ...
                      className="w-[220px] p-3 lg:w-[200px] h-6 lg:h-8 rounded"
                    />
                  </div>
